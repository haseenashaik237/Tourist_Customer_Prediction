...
# CONFIG
# -----------------------------
MODEL_REPO_ID = "BujjiProjectPrep/tourist_customer_prediction_model_0612"
...
def main():
    ...
    # Collect inputs for all model features (same as in training)
    Age = st.number_input("Age", min_value=18, max_value=100, value=35)
    TypeofContact = st.selectbox("Type of Contact", ["Self Enquiry", "Company Invited"])
    CityTier = st.selectbox("City Tier", [1, 2, 3])
    DurationOfPitch = st.number_input("Duration of Pitch (minutes)", min_value=0.0, max_value=120.0, value=15.0, step=1.0)
    ...
    # Convert to DataFrame (Rubric: "Get inputs and save them into a dataframe")
